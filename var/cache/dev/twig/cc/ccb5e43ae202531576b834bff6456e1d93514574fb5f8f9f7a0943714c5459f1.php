...
class __TwigTemplate_ca946d9e44c1b042d04724bbe925a1757f225e671d2cac9b713cfad8f84da4bf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-outline-success my-3\">{{ button_label|default('Ajouter') }}</button>
{{ form_end(form) }}
", "task/_form.html.twig", "C:\\Users\\marwen.abbes\\Desktop\\ProjectManager-master\\templates\\task\\_form.html.twig");
    }
}
